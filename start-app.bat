...
REM  Start order: PostgreSQL -> Redis -> Backend (Docker) -> Frontend (Docker)
REM
REM  Usage:
...
echo   -----------------
echo   Frontend     :  stockbrokerage-frontend  (vkdocker/stock-brokerage-frontend)
echo   Backend      :  stockbrokerage-backend   (vkdocker/stock-brokerage-backend)
echo   PostgreSQL   :  stockdb-postgres
echo   Redis        :  stockdb-redis
echo.
